...
You can take specific actions when users sign-in or sign-out by subscribing to authentication events in your app. Please see our [Hub Module Developer Guide](/[platform]/build-a-backend-test/auth/connect-your-frontend/listen-to-auth-events/) for more information.

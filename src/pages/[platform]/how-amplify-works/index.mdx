...
<View backgroundColor="red"><Text color="blue">Inaccessible text</Text></View>

<img src="/images/how-amplify-works/amplify-flow.png" />
...
| Features | Swift | Android | Flutter | JavaScript |
| :-- | :-: | :-: | :-: | :-: |
